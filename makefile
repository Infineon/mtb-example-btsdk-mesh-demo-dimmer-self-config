...
# Basic Configuration
#
APPNAME=BLE_Mesh_DimmerSelfConfig
TOOLCHAIN=GCC_ARM
CONFIG=Debug
VERBOSE=
...
#CY_APP_DEFINES += -DREMOTE_PROVISION_OVER_GATT_SUPPORTED
#CY_APP_DEFINES += -DGATT_PROXY_CLIENT_SUPPORTED
endif
